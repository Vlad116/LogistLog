package ru.itis.logistic_service.localization;
...
public class Localizations {
    ...
    public static Map<String, String> loadLocalization(String locale) {
        ...
        Scanner scanner = new Scanner(new File("C:\\Users\\Nadin\\Desktop\\LogisticService\\src\\main\\resources\\messages\\messages_" + locale + ".properties"));
